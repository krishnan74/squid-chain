...
export async function GET(req: NextRequest,) {
  ...
  const transactionTool = createTool({
    ...
    await transaction.wait(); 
      ...
      return {feel:feel,status:"Transaction successful",transactionHash:transaction.hash,player:"player3"};
    },
  });
  ...
  const numberpicktool = createTool({
    ...
    execute: async (_args) => {
      ...
      return {choice:choice,feel:`i choose team${choice}`,player:"player3"};
    },
  });
  ...
  const smartcontractTool = createTool({
    ...
    execute: async (_args) => {
      ...
      return {txHash: tx.hash, message: "winner",feel:_args.feel,player:"player3"};
    },
  });
